...
def _add_plot(
    ...
    if series.plot_type == "c":
        # originpro-cli-plot integration, 2026-09-02: Origin 2025 keeps the
        # column border separate from plot.color; set the declared edge explicitly.
        plot.set_cmd(f"-c {int(op.ocolor(series.color))}")
