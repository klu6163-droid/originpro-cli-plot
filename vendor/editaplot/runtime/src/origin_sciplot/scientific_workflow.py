...
class ScientificPlotSpec:
    ...
    # originpro-cli-plot integration, 2026-09-02: freeze the calibration display helper.
    calibration_count_scale: float | None = None
...
def _build_calibration_curve_spec(
    ...
    return (
        ScientificPlotSpec(
            ...
            calibration_count_scale=0.12 / float(np.max(counts)),
            display_plan=ScientificDisplayPlan(7.0, 0.8, 0.72, figure_style=style),
            axis_plan=ScientificAxisPlan(0.0, 1.0, 0.2, 0.0, 1.0, 0.2),
